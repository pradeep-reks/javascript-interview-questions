...
15. ### What is the currying function
    ...
    Using currying with REST APIs in React is an excellent way to eliminate repetitive code by pre-configuring API clients with base URLs, headers, or specific HTTP methods.
...
131. ### What are the pros and cons of for loop
...
151. ### Can you write a random integers function to print integers with in a range
...
156. ### What are the string methods available in Regular expression
...
178. ### Give an example where do you really need semicolon
